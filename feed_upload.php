...
<body>
    ...
    <div class="form-group"><br><br>
        ...
        if (isset($_POST['upload'])) {
            ...
            $folder = "assets/pictures/" . $imageName;

            // Loop through the uploaded images and insert filenames into the database


            $sql = "INSERT INTO feedback_image (image_name) VALUES ('$imageName')";
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <button class="btn"><a href="./suggestionchanges.php" style="color:#fff; text-decoration:none;">Back</a></button>
        </div>
    </form>
