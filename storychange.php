        ...
        <div class="contact_form">
          <form method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" class="form-control" placeholder="Please enter the title here" vaule="<?php echo (($storys_data['name'] != "") ? $storys_data['name'] : ""); ?>" required>
            </div>
            <div class="form-group">
              <label for="image">CoverImage</label>
              <?php if (!empty($storys_data["image"])) { ?>
                <img alt="Image placeholder" src="./uploads/storys/<?= $storys_data["image"]; ?>" class="avatar rounded mr-3 ">
                <input type="hidden" name="image_name" id="image_name" class="form-control" placeholder="Please the select the image in jpg/png" value="<?php echo $storys_data['image']; ?>">
              <?php } ?>
            ...
            <div class="form-group">
              <label for="message">Story Description</label>
              <textarea name="message" id="message" class="form-control" placeholder="Please enter the description here" value="<?php echo (($storys_data['message'] != "") ? $storys_data['message'] : ""); ?>" required>
                            </textarea>
            </div>
            <?php
            if (!empty($storys_data['id'])) {
            ?>
              <button class="loginbtn" name="update-storys" value="add-storys">Update Story</button>
            <?php } else { ?>
              <button class="loginbtn" name="add-storys" value="add-storys">Add Story</button>
            <?php } ?>
          </form>
        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="media align-items-center">
                        <img alt="Image placeholder" src="./uploads/storys/<?= $row["image"]; ?>" class="news_img">
                    ...
                    <td>
                      <a href="storychange.php?edit=<?= $row["id"]; ?>" class="btn" style="color:whitesmoke; text-decoration:none;"> Edit </a> |
                      <a href="storychange.php?id=<?= $row["id"]; ?>" class="btn" style="color:whitesmoke; text-decoration:none;"> Delete </a>
                    </td>
                  </tr>
              <?php
                  $i++;
