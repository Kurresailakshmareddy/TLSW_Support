...
<body>
  ...
  <div class="drop_wrapper">
    <div class="gallery_wrap">
      ...
      <div class="gallery-sidebar" id="gallerySidebar">
        <div class="upload_btn" id="uploadButton">
          <a href="./activity3_upload.php" style="text-decoration:none;">Upload </a>
        </div>
    ...
    <div class="drop_main_wrapper">
      ...
      <div class="drop-frame" id="dropFrame1">
        <!-- The dropped images will appear here -->
        <h4>Present</h4>
        <div class="placeholder"></div>
      </div>
      <div class="drop-frame" id="dropFrame2">
        <!-- The dropped images will appear here -->
        <h4>Future</h4>
        <div class="placeholder"></div>
      </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      uploadButton.addEventListener('click', () => {
        ...
        window.location.href = './activity3_upload.php';
      });
    });
    ...
    function deleteSelectedImages() {
      ...
      xhr.open('POST', 'delete_story.php', true);
    ...
    function reloadGallery() {
      ...
      const xhr = new XMLHttpRequest();
      xhr.open('GET', 'get_story.php', true);
      xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            uploadButton.innerHTML = '<a href="./activity3_upload.php">Upload</a>';
