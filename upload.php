...
<body>
    ...
    <div class="form-group"><br><br>
        ...
        if (isset($_POST['upload'])) {
            ...
            $sql = "INSERT INTO image_gallery (image_name) VALUES ('$imageName')";
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <button class="btn"><a href="./activityChange.php" style="color:#fff; text-decoration:none;">Back</a></button>
        </div>
    </form>
